    ...
    return MultiProvider(
      ...
      child: LayoutBuilder(
        builder: (context, constraint) {
          ...
          // Size data
          Size parentSize, leftAxisSize = Size.zero, titleSize = Size.zero, canvasSize = Size.zero, bottomAxisSize = Size.zero, bottomLabelSize = Size.zero, bottomLegendSize = Size.zero;
          double parentWidth, leftAxisStaticWidth, canvasWidth;
          double parentHeight, titleStaticHeight, bottomAxisStaticHeight, bottomLabelStaticHeight, bottomLegendStaticHeight, canvasHeight;
          parentHeight = constraint.maxHeight < double.infinity ? constraint.maxHeight : MediaQuery.of(context).size.height;
          parentWidth = constraint.maxWidth < double.infinity ? constraint.maxWidth : MediaQuery.of(context).size.width;
          parentSize = Size(parentWidth, parentHeight);

          // Get static sizes of components
          leftAxisStaticWidth = ChartAxisVerticalWithLabel.getWidth(style.yAxisStyle.label.text, data.yValueRange[1], style.yAxisStyle);
          ...
          // Components
          var chartTitle, bottomLabel, chartCanvas, miniCanvas, bottomAxis, leftAxis, bottomLegend;
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ChartLegendHorizontal(
                  ...
                  width: canvasWidth / 6,
                  label: BarChartLabel(
                    text: data.xSubGroups[index],
                    textStyle: style.legendTextStyle,
                  ),
                  color: data.subGroupColors[data.xSubGroups[index]],
                );
              },
            ),
          );
